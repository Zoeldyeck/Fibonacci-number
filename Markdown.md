...
##### In mathematics, a Fibonacci sequence is a row in which each term is the sum of the previous two terms. The numbers that are part of the Fibonacci sequence are known as Fibonacci numbers, generally notated as (Fn).
```
